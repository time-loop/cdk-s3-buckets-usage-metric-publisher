/**
 * Retrieves usage metrics from CloudWatch for the last 5 minutes.
 * The AWS Lambda resource is managed from test/integ.s3-buckets-usage-metric-publisher.ts
...
exports.handler = async () => {
  ...
  const params: GetMetricDataCommandInput = {
    ...
    MetricDataQueries: [
      {
        Id: 'm1',
        Label: 'S3 General Purpose Buckets usage',
        MetricStat: {
          Metric: {
            Namespace: 'S3GeneralPurposeBucketsUsage',
